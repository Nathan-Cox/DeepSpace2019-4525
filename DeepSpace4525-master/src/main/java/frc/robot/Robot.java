...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    this.hatchPunchTopIn = new Solenoid(0, 5); // PCM 0 port 4
    this.hatchPunchTopOut = new Solenoid(0, 4); // PCM 0 port 5 
  ...
  public void configureSpeedControllers(){ 
    ...
    this.elevator.config_kP(0, 0.49951172, 30);
    this.elevator.config_kI(0, 0, 30);
    this.elevator.config_kD(0, 0, 30);
    this.elevator.config_kF(0, 0, 30);
